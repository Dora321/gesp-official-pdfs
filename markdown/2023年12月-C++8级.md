...
- 原始 PDF: [pdfs/2023年12月-C++8级.pdf](../pdfs/2023%E5%B9%B412%E6%9C%88-C++8%E7%BA%A7.pdf)
- 页数: 11
- 转换方式: PDF 文本层为主，缺失的题目代码以人工校对的 Markdown 代码块补入。
- PDF SHA-256: `17316ebcb8543990cc59e49592a201e870bfd271eeaa642f19e37f24be7b7421`
...
学获得了不同种类的奖品，即视为不同的方案。方便起见，你只需要输出方案数对
 取模后的结果即可。
...
接下来  行，每行若干用单个空格隔开的正整数。首先是两个正整数
，接着是
 个正整数
。
